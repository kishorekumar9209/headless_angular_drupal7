...
angular.module("EcommApp")
        ...
        .controller('CategoryWiseController', ['$scope', '$http', '$location', 'drupalSettings', '$routeParams', 'Service',
            function ($scope, $http, $location, drupalSettings, $routeParams, Service) {
